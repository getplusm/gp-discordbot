...
public class AuditLogEntry implements ISnowflake
{
    ...
    /**
     * Key-Value {@link Map Map} containing all {@link AuditLogChange
    ...
    /**
     * Key-Value {@link Map Map} containing all Options made in this entry. The keys for the returned map are
