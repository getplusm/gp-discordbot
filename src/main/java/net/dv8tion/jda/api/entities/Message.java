...
public interface Message extends ISnowflake, Formattable
{
     ...
     *
     * @see MessageAction#addFile(File, net.dv8tion.jda.api.utils.AttachmentOption...) MessageAction.addFile(...)
     */
     ...
     * filtered by the specified {@link MentionType MentionType} values.
     ...
     *
     * @param  types
     *         Amount of {@link MentionType MentionTypes}
     ...
     * <br>If no filtering {@link MentionType MentionTypes} are
     * specified this will fallback to all mention types.
     *
     * <p>{@link MentionType#HERE MentionType.HERE} and {@link MentionType#EVERYONE MentionType.EVERYONE}
     * will only be checked, if the given {@link IMentionable IMentionable} is of type
     * {@link User User} or {@link Member Member}.
     * <br>Online status of Users/Members is <b>NOT</b> considered when checking {@link MentionType#HERE MentionType.HERE}.
     *
     * @param  mentionable
     *         The mentionable entity to check on.
     * @param  types
     *         The types to include when checking whether this type was mentioned.
     *         This will be used with {@link #getMentions(MentionType...) getMentions(MentionType...)}
     *
     * @throws UnsupportedOperationException
     *         If this is not a Received Message from {@link MessageType#DEFAULT MessageType.DEFAULT}
     *
     ...
     *         or not {@link MessageEmbed#isSendable() sendable}
     *
     * @return {@link MessageAction MessageAction}
     *         <br>The {@link Message Message} with the updated content
     */
     ...
     *         If this message was <b>not</b> sent in a
     *         {@link Guild Guild}
     *         <b>and</b> the given user is <b>not</b> the {@link SelfUser SelfUser}.
     *
     * @return {@link RestAction RestAction} - Type: {@link Void}
     *
     * @since  4.1.0
