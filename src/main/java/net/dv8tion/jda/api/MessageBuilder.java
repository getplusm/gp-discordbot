 ...
 * <br>Internally the builder uses a {@link StringBuilder} to take advantage of the efficiencies offered by the
...
public class MessageBuilder implements Appendable
{
    ...
    /**
     * Appends a String using the specified chat {@link Formatting Formatting(s)}.
     *
     * @param  text
     *         the text to append.
     * @param  format
     ...
     * {@link #buildAll(SplitPolicy...) buildAll(SplitPolicy...)} as possible ways to
     ...
     * <br>If {@link #setAllowedMentions(Collection)} does not contain {@link Message.MentionType#USER MentionType.USER}
     ...
     * <br>If {@link #setAllowedMentions(Collection)} does not contain {@link Message.MentionType#ROLE MentionType.ROLE}
    ...
    /**
     * Sets which {@link Message.MentionType MentionTypes} should be parsed from
    ...
    /**
     * Adds the provided {@link Message.MentionType MentionTypes} to the whitelist.
     *
     * @param  types
    ...
    /**
     * Removes the provided {@link Message.MentionType MentionTypes} from the whitelist.
     *
     * @param  types
    ...
    /**
     * Creates a {@link Queue Queue} of {@link Message Message} objects from this MessageBuilder.
     *
     ...
     *
     * @param  policy
     *         The {@link SplitPolicy} defining how to split the text in the
     ...
     * {@link #buildAll(SplitPolicy...) MessageBuilder.buildAll(SplitPolicy...)}.
     */
    public interface SplitPolicy
    {
         ...
         *
         * @throws IllegalStateException when splitting fails
         *
         */
    ...
    /**
     * Holds the available formatting used in {@link MessageBuilder#append(CharSequence, Formatting...)}
     */
