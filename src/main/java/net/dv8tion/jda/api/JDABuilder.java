...
/**
 * Used to create new {@link JDA} instances. This is also useful for making sure all of
 ...
 * creates a new {@link JDA} instance using the same information.
 * This means that you can have listeners easily registered to multiple {@link JDA} instances.
 */
public class JDABuilder
{
     ...
     *
     * @see    <a href="https://www.slf4j.org/api/org/slf4j/MDC.html" target="_blank">MDC Javadoc</a>
     * @see    #setContextMap(ConcurrentMap)
     */
    @Nonnull
