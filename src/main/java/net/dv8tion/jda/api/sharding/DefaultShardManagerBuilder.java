...
public class  DefaultShardManagerBuilder
{
     ...
     * @return The DefaultShardManagerBuilder instance. Useful for chaining.
     *
     * @see    net.dv8tion.jda.api.managers.Presence#setActivity(Activity)
     */
    @Nonnull
    ...
    /**
     * Sets the {@link ThreadFactory ThreadFactory} that will be used by the internal executor
     * of the ShardManager.
