 ...
 *
 * @param <T>
 *        The entity type for the {@link List List} of entities
...
public interface OrderAction<T, M extends OrderAction<T, M>> extends RestAction<Void>
{
     ...
     * {@link java.util.Collections#reverse(List) Collections.reverse(orderList)}
     *
     * @return The current OrderAction sub-implementation instance
     *
     ...
     * {@link java.util.Collections#shuffle(List) Collections.shuffle(orderList)}
     *
     * @return The current OrderAction sub-implementation instance
     *
     ...
     * the specified {@link Comparator Comparator}.
     * <br>Using {@link java.util.ArrayList#sort(Comparator) ArrayList.sort(comparator)}
     *
     * @param  comparator
