...
/**
 * {@link Invite Invite} Builder system created as an extension of {@link net.dv8tion.jda.api.requests.RestAction}
...
public interface InviteAction extends AuditableRestAction<Invite>
{
     ...
     *         The max age for this invite or {@code null} to use the default value.
     * @param  timeUnit
     *         The {@link TimeUnit TimeUnit} type of {@code maxAge}.
     *
     * @throws IllegalArgumentException
