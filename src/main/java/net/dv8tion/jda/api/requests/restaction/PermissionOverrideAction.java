...
public interface PermissionOverrideAction extends AuditableRestAction<PermissionOverride>
{
     ...
     * @return The current PermissionOverrideAction - for chaining convenience
     *
     * @see    #setAllow(Collection) setAllow(Collection)
     ...
     * @return The current PermissionOverrideAction - for chaining convenience
     *
     * @see    #setDeny(Collection) setDeny(Collection)
     ...
     * @return The current PermissionOverrideAction - for chaining convenience
     *
     * @see    #setPermissions(Collection, Collection)
    ...
    /**
     * Combination of {@link #setAllow(Collection)} and {@link #setDeny(Collection)}
