 ...
 * will be executed by a {@link ScheduledExecutorService ScheduledExecutorService} after a
 * specified delay:
 * <ul>
 ...
 *     <br>The {@link TimeUnit TimeUnit} is used to convert the provided long into a delay time.
 ...
 *     <br>This returns a {@link ScheduledFuture ScheduledFuture} which
 ...
 * {@link ScheduledExecutorService ScheduledExecutorService} instead of using the default
 * global JDA executor. Specifically {@link #queueAfter(long, TimeUnit)} has overloads
 * to provide a success and/or failure callback due to the returned {@link ScheduledFuture ScheduledFuture}
 ...
 * callback {@link Consumer Consumer} or the (not recommended) {@link #complete()} which will block
 ...
 *     {@link Consumer Consumer}{@literal <Message>} callback = (message) {@literal ->  {
...
public interface RestAction<T>
{
     ...
     *
     * <p>To access the response you can use {@link #queue(Consumer)}
     * and to handle failures use {@link #queue(Consumer, Consumer)}.
     *
     ...
     *
     * @see net.dv8tion.jda.api.entities.MessageChannel#sendMessage(CharSequence) MessageChannel.sendMessage(CharSequence)
     * @see net.dv8tion.jda.api.requests.restaction.MessageAction MessageAction
     * @see #queue(Consumer) queue(Consumer)
     * @see #queue(Consumer, Consumer) queue(Consumer, Consumer)
     */
    default void queue()
    {
        queue(null);
     ...
     *
     * <p>To handle failures use {@link #queue(Consumer, Consumer)}.
     *
     * <p><b>This method is asynchronous</b>
     *
     * <h2>Example</h2>
    ...
    /**
     * Submits a Request for execution and provides a {@link CompletableFuture CompletableFuture}
     ...
     *         If the requester has been shutdown by {@link JDA#shutdown()} or {@link JDA#shutdownNow()}
     *
     * @return Never-null {@link CompletableFuture CompletableFuture} representing the completion promise
     */
    @Nonnull
     ...
     *
     * @return Never-null {@link CompletableFuture CompletableFuture} task representing the completion promise
     */
    @Nonnull
     ...
     *
     * <p>The global JDA RateLimit {@link ScheduledExecutorService ScheduledExecutorService}
     ...
     * @param  unit
     *         The {@link TimeUnit TimeUnit} to convert the specified {@code delay}
     *
     * @throws IllegalArgumentException
     ...
     *         The {@link TimeUnit TimeUnit} to convert the specified {@code delay}
     * @param  executor
     *         The {@link ScheduledExecutorService ScheduledExecutorService} that should be used
     ...
     * @param  unit
     *         The {@link TimeUnit TimeUnit} which should be used
     *         (this will use {@link TimeUnit#sleep(long) unit.sleep(delay)})
     *
     * @throws IllegalArgumentException
     *         If the specified {@link TimeUnit TimeUnit} is {@code null}
     ...
     *
     * <p>The global JDA {@link ScheduledExecutorService ScheduledExecutorService} is used for this operation.
     ...
     *         The {@link TimeUnit TimeUnit} to convert the specified {@code delay}
     * @param  success
     *         The success {@link Consumer Consumer} that should be called
     ...
     * @param  failure
     *         The failure {@link Consumer Consumer} that should be called
     ...
     *         The {@link TimeUnit TimeUnit} to convert the specified {@code delay}
     * @param  executor
     *         The Non-null {@link ScheduledExecutorService ScheduledExecutorService} that should be used
