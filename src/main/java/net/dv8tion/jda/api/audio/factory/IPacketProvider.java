...
public interface IPacketProvider
{
     ...
     * <br>The {@link ByteBuffer#position()} will be positioned on the start of the packet to send
     * and the {@link ByteBuffer#limit()} at the end of it. Use {@link ByteBuffer#remaining()}
     ...
     *         Whether or not to change the talking indicator if the AudioSendHandler cannot provide a new audio packet.
     *
     * @return Possibly-null {@link DatagramPacket DatagramPacket} containing an encoded and encrypted packet
     *         of audio data ready to be sent to discord.
     */
    @Nullable
