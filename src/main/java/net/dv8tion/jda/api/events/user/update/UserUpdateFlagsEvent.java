...
/**
 * Indicates that the {@link User.UserFlag UserFlags} of a {@link User User} changed.
 * 
...
public class UserUpdateFlagsEvent extends GenericUserUpdateEvent<EnumSet<User.UserFlag>>
{
    ...
    /**
     * Gets the old {@link User.UserFlag UserFlags} of the User as {@link EnumSet}.
     * 
     * @return {@link EnumSet} of the old {@link User.UserFlag UserFlags}
     */
    @Nonnull
    ...
    /**
     * Gets the old {@link User.UserFlag UserFlags} of the user and returns it as bitmask representation.
     * 
     * @return The old bitmask representation of the {@link User.UserFlag UserFlags}.
     */
    ...
    /**
     * Gets the new {@link User.UserFlag UserFlags} of the User as {@link EnumSet}.
     *
     * @return The new {@code EnumSet<{@link User.UserFlag UserFlag}>} representation of the User's flags.
     */
    @Nonnull
    ...
    /**
     * Gets the new {@link User.UserFlag UserFlags} of the user and returns it as bitmask representation.
     *
     * @return The new bitmask representation of the {@link User.UserFlag UserFlags}.
     */
