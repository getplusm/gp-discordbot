 ...
 * <br>Check the flag descriptions to see which {@link GatewayIntent intents} are required to use them.
 */
public enum CacheFlag
{
     ...
     *
     * <p>Requires {@link GatewayIntent#GUILD_PRESENCES GUILD_PRESENCES} intent to be enabled.
     */
     ...
     *
     * <p>Requires {@link GatewayIntent#GUILD_VOICE_STATES GUILD_VOICE_STATES} intent to be enabled.
     */
    VOICE_STATE(GatewayIntent.GUILD_VOICE_STATES),
    /**
     * Enables cache for {@link Guild#getEmoteCache()}
     *
     * <p>Requires {@link GatewayIntent#GUILD_EMOJIS GUILD_EMOJIS} intent to be enabled.
     */
