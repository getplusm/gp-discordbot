 ...
 *
 * @see #sanitize(String, SanitizationStrategy)
 *
 * @since  4.0.0
 */
public class MarkdownSanitizer
{
     ...
     *         The string to sanitize
     * @param  strategy
     *         The {@link SanitizationStrategy} to apply
     *
    ...
    /**
     * Switches the used {@link SanitizationStrategy}.
     *
     * @param  strategy
     *         The new strategy
     *
     ...
     * <br>Uses the specified {@link SanitizationStrategy} and
