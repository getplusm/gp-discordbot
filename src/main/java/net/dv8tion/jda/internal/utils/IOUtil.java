...
public class IOUtil
{
     ...
     *
     * <p>This customized version for File is provide (instead of just using {@link #readFully(InputStream)} with a FileInputStream)
     * because with a File we can determine the total size of the array and do not need to have a buffer.
     * This results in a memory footprint that is half the size of {@link #readFully(InputStream)}
     *
     ...
     * @param  stream
     *         The {@link InputStream InputStream} to be transmitted
     *
